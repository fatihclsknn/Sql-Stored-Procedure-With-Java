...
@NamedStoredProcedureQuery(
        name = "Branch.get",
        procedureName = "get_branch",
        parameters = {
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "p_branch_id", type = Long.class)
        },
        resultClasses = Branch.class
)
@NamedStoredProcedureQuery(
        name = "Branch.delete",
        procedureName = "delete_branch",
        parameters = {
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "p_branch_id", type = Long.class)
        }
)
